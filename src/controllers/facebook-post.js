...
/**
 * Get Facebook post comments by post ID
...
exports.getPostId = async (req, res) => {
    ...
    try {
        const endpoint = `/facebook/posts?page_access_token=${query.account_token}&post_id=${query.post_id}`;
        ...
        loggerHelper.error({
            source: 'facebook-post:getPostId',
            message,
            error: err?.cause
        });
