...
/**
 * Get Instagram message details by message ID
...
exports.getMessageById = async (req, res) => {
    ...
    try {
        const endpoint = `/instagram/messengers?page_access_token=${query.account_token}&message_id=${query.message_id}`;
        ...
        loggerHelper.error({
            source: 'instagram-message:getMessageById',
            message,
            error: err?.cause
        });
...
/**
 * Get Instagram message history by sender ID
 * @param {import('express').Request} req - Express request
 * @param {import('express').Response} res - Express response
 */
exports.getMessageBySenderId = async (req, res) => {
    ...
    try {
        const endpoint = `/instagram/messengers/profile?page_access_token=${query.account_token}&sender_id=${query.sender_id}`;
        const api = await apiHelper.get(endpoint);
        ...
        loggerHelper.error({
            source: 'instagram-message:getMessageBySenderId',
            message,
            error: err?.cause
        });
...
/**
 * Send text message to Instagram Direct recipient
 * @param {import('express').Request} req - Express request
 * @param {import('express').Response} res - Express response
 */
exports.sendMessageText = async (req, res) => {
    ...
    try {
        const endpoint = `/instagram/messengers/send_text?page_access_token=${body.account_token}`;
        ...
        loggerHelper.error({
            source: 'instagram-message:sendMessageText',
            message,
            error: err?.cause
        });
...
/**
 * Send media attachment message to Instagram Direct recipient
 * @param {import('express').Request} req - Express request
 * @param {import('express').Response} res - Express response
 */
exports.sendMessageMedia = async (req, res) => {
    ...
    try {
        const endpoint = `/instagram/messengers/send_attachment?page_access_token=${body.account_token}`;
        const api = await apiHelper.post(endpoint, {
            recipient_id: body.recipient_id,
        ...
        loggerHelper.error({
            source: 'instagram-message:sendMessageMedia',
            message,
            error: err?.cause
        });
